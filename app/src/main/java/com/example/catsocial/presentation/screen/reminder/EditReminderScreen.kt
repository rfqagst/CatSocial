...
fun EditReminderScreen(
    ...
    when (reminder) {
        ...
        is Resource.Success -> {
            ...
            val formattedTime = remember { mutableStateOf(initialTime.format(DateTimeFormatter.ofPattern("HH:mm"))) }
            ...
            ClockDialog(
                ...
                selection = ClockSelection.HoursMinutes { hours, minutes ->
                    ...
                    formattedTime.value = selectedTime.value.format(DateTimeFormatter.ofPattern("HH:mm"))
